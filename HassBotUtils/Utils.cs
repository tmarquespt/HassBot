...
namespace HassBotUtils
{
    public sealed class Utils
    {
        ...
        private static readonly string ERR_JSON2YAML = "Isso não parece ser código JSON válido. Não é possível efectuar a conversão!";
        private static readonly string ERR_YAML2JSON = "Isso não parece ser código YAML válido. Não é possível efectuar a conversão!";
